    ...
    public class CurrentActivityReportAddon : AddonBaseClass {
        ...
        public override object Execute(CPBaseClass cp) {
            try {
                ...
                //        Stream.Append("<td style=\"width:150px;border-bottom:1px solid #888;\" valign=top>" + SpanClassAdminNormal + $"<a target=\"_blank\" href=\"/admin?addonGuid={"fix"}&DateFrom={DateTime.Now.Date.ToShortDateString()}&DateTo={DateTime.Now.Date.ToShortDateString()}\">" + VisitCount + "</A>, " + string.Format("{0:N2}", PageCount) + " pages/visit.</span></td>");
